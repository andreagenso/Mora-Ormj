...
/**
 * Provides methods to obtain the position of a Tree within a CompilationUnit.mora.
 * A position is defined as a simple character offset from the start of a
 * CompilationUnit.mora where the first character is at offset 0.
 *
...
public interface SourcePositions {
     ...
     * </p>
     *
     * @param file CompilationUnit.mora in which to find tree.
